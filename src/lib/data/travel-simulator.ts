...
export const getEnrichedData = (
  location: string,
  type: "hotel" | "activity" | "flight",
  fromLocation?: string
) => {
  const normalizedLocation =
    destinationAliases[location.toLowerCase()] || location.toLowerCase();
      ...
      hotels: [
        {
          ...
          description:
            "Resor mewah bertenaga surya sepenuhnya dengan sistem daur ulang air tercanggih di Bali.",
          reviews: [
        ...
        },
        {
          ...
          description:
            "Hotel bambu ikonik yang menyatu dengan alam, mendukung petani lokal secara langsung.",
          reviews: [
      ...
      hotels: [
        {
          ...
          description:
            "Pusat konservasi laut yang menyamar menjadi resor mewah. Setiap dolar Anda digunakan untuk melindungi hiu.",
          reviews: [
